...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.014849, 34.101354],
    // zoom: 4
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Eroor logging out, Try again.');
...
var stripe = Stripe('pk_test_51J4QonGUK4WQqLDfVXlf9hyquc6fSE9afkCJ3asEuBAUz0MfEtwGxRiXjIZilIsurmrPHLRoXcDEAgzZchAZqIvu00Kbz7J7PP');
